...
string trim_region    {"[500:1800,300:750]",prompt="Trim region"}
...
ccdproc(images="*.fits",ccdtype='',fixpix=yes,fixfile="/home/ysy/iraf/APO/APO_pipeline/badpix_blue",oversca=no,trim=no,zerocor=no,darkcor=no,flatcor=no)
