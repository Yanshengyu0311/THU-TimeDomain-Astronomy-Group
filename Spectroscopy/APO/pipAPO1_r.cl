...
string trim_region    {"[10:2030,500:900]",prompt="Trim region"}
string badpixfile     {"/scisoft/share/iraf/iraf/demo/apobadpixs",prompt="File of bad pixels"}
...
ccdproc(images="*.fits",ccdtype='',fixpix=yes,fixfile=badpixfile,oversca=no,trim=no,zerocor=no,darkcor=no,flatcor=yes,flat="nFlat",biassec="[2051:2096,2:1027]")
