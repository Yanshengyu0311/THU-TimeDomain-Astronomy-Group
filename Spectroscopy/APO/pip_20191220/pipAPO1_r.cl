...
real   readnoise      {4.6,prompt="Readnoise"}
real   gain           {1.88,prompt="Gain"}
string trim_region    {"[250:1750,300:750]",prompt="Trim region"}
string badpixfile     {"/home/ysy/iraf/APO_data/pipline/badpix",prompt="File of bad pixels"}
...
ccdproc(images="*.fits",output="",ccdtype='',fixpix=no,oversca=yes,trim=no,zerocor=yes,darkcor=no,flatcor=no,zero="Zero",biassec="[2051:2096,2:1027]")
print("**********************************************")
...
ccdproc(images="*.fits",output="",ccdtype='',fixpix=no,oversca=no,trim=yes,zerocor=no,darkcor=no,flatcor=no,trimsec=trim_region,biassec="[2051:2096,2:1027]")
...
ccdproc(images="*.fits",output="",ccdtype='',fixpix=yes,fixfile=badpixfile,oversca=no,trim=no,zerocor=no,darkcor=no,flatcor=yes,flat="nFlat",biassec="[2051:2096,2:1027]")
